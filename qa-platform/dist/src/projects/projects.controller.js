...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a project (Admin/Lead only)' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get a single project with stats' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)(enums_js_1.Role.ADMIN, enums_js_1.Role.LEAD),
    (0, swagger_1.ApiOperation)({ summary: 'Update a project (Admin/Lead only)' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
